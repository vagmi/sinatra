...
Liquid templates need the liquid gem installed. Since liquid is meant to be a safe language, you would have to do {{ content }} in your layouts instead of an yield.
